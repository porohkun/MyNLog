...
namespace MyNLog.Misc
{
    public class ListBoxBehavior
    {
        ...
        private class Capture : IDisposable
        {
            ...
            {
                _scrollViewer = FindChild(listBox);
            ...
            private ScrollViewer FindChild(DependencyObject root)
            {
            ...
            private void incc_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
            {
                ...
                {
                    if (_scrollViewer.ScrollableHeight - _scrollViewer.VerticalOffset < 3)
